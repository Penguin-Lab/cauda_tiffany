...
#define XCLK_GPIO_NUM    10  // MCLK
#define SIOD_GPIO_NUM    21 // SDA
#define SIOC_GPIO_NUM    14 // SCK

#define Y9_GPIO_NUM      11 // Y9
...
#define VSYNC_GPIO_NUM   13 // VS
#define HREF_GPIO_NUM    12 // HS
#define PCLK_GPIO_NUM    7 // PCLK
